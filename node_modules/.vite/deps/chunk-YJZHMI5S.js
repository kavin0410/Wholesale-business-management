// node_modules/@21st-extension/toolbar/dist/jsx-runtime-BI3iOU20.js
var n$1;
var l$1;
var u$1;
var t$1;
...
function O(n2, u2, t2, i2, r2, o2, e2, f2, c2, s2) {
  ...
  n: if (typeof j2 == "function") try {
    if (b2 = u2.props, S2 = "prototype" in j2 && j2.prototype.render, C2 = (a2 = j2.contextType) && i2[a2.__c], M2 = a2 ? C2 ? C2.props.value : a2.__ : i2, t2.__c ? m2 = (h2 = u2.__c = t2.__c).__ = h2.__E : (S2 ? u2.__c = h2 = new j2(b2, M2) : (u2.__c = h2 = new x(b2, M2), h2.constructor = j2, h2.render = D), C2 && C2.sub(h2), h2.props = b2, h2.state || (h2.state = {}), h2.context = M2, h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), S2 && h2.__s == null && (h2.__s = h2.state), S2 && j2.getDerivedStateFromProps != null && (h2.__s == h2.state && (h2.__s = d({}, h2.__s)), d(h2.__s, j2.getDerivedStateFromProps(b2, h2.__s))), v2 = h2.props, y2 = h2.state, h2.__v = u2, p2) S2 && j2.getDerivedStateFromProps == null && h2.componentWillMount != null && h2.componentWillMount(), S2 && h2.componentDidMount != null && h2.__h.push(h2.componentDidMount);
    else {
      if (S2 && j2.getDerivedStateFromProps == null && b2 !== v2 && h2.componentWillReceiveProps != null && h2.componentWillReceiveProps(b2, M2), !h2.__e && h2.shouldComponentUpdate != null && h2.shouldComponentUpdate(b2, h2.__s, M2) === false || u2.__v == t2.__v) {
...
function V(u2, t2, i2, r2, o2, e2, f2, c2, s2) {
  ...
  if (x2 == null) b2 === k2 || c2 && u2.data == k2 || (u2.data = k2);
    ...
    else if (v2 && (u2.innerHTML = ""), I(t2.type == "template" ? u2.content : u2, w(y2) ? y2 : [y2], t2, i2, r2, x2 == "foreignObject" ? "http://www.w3.org/1999/xhtml" : o2, e2, f2, e2 ? e2[0] : i2.__k && S(i2, 0), c2, s2), e2 != null) for (a2 = e2.length; a2--; ) g(e2[a2]);
...
n$1 = v.slice, l$1 = { __e: function(n2, l2, u2, t2) {
...
//# sourceMappingURL=chunk-YJZHMI5S.js.map
